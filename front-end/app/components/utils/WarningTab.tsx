...
const WarningTab = () => {
  return (
        <div className='mx-auto chat-textbox-container-after text-left mb-[150px]'>
            <div className="flex justify-center">
                <div className="mb-2 flex flex-col gap-3.5 pt-2">
                    <div className="text-token-text-primary border-token-border-light bg-token-main-surface-primary w-[768px] flex w-full items-start rounded-2xl border text-sm bg-opacity-10 px-3 py-2.5 md:p-4">
