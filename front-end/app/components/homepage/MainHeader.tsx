      ...
      <div className="flex items-center gap-0 ml-[4px] max-md:justify-center max-md:w-full">
        ...
        <span className="flex" data-state="closed" onClick={toggleClearChat}>
            <BootstrapTooltip title="New chat" placement="bottom">
              <button
                aria-label="New chat"
                className="text-[#5D5D5D] h-10 rounded-lg px-2 text-token-text-secondary focus-visible:outline-0 disabled:text-token-text-quaternary focus-visible:bg-token-sidebar-surface-secondary enabled:hover:bg-token-sidebar-surface-secondary enabled:hover:bg-[rgba(0,0,0,0.075)]"
              >
                <svg
                  width="24"
                  height="24"
        ...
        aria-label="Model selector, current model is 4o mini"
          ...
          <svg width="18"
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="text-[#B3B3B3] icon-md text-token-text-tertiary">
